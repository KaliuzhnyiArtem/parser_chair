...
3. Перейдіть в клоновану папку проєта. Створити віртуальне середовище(якщо у вас вже встановлений python)
...
Помістіть розпакований файл у папку проєкта замінивши старий файл
